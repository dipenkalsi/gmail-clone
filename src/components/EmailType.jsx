  ...
  return (
    <div className={ `${theme==="dark"?"":"border-b"} ${theme}`}>
      <div className='options flex items-center justify-start'>
        ...
        <div className='flex items-center dark:hover:border-gray-100 justify-center space-x-3 font-semibold dark:hover:bg-gray-100 dark:hover:text-gray-600 dark:text-gray-100 text-gray-500 hover:bg-gray-50 transition-all ease-in duration-150 cursor-pointer py-3 pl-5 pr-28 border-b-2 border-white dark:border-[#00001a] hover:border-gray-50'>
            <PeopleAltIcon/>
            <p>Socials</p>
        </div>
        <div className='flex dark:hover:bg-gray-100 dark:hover:border-gray-100 dark:hover:text-gray-600 items-center justify-center space-x-3 font-semibold dark:text-gray-100 text-gray-500 hover:bg-gray-50 transition-all ease-in duration-150 cursor-pointer py-3 pl-5 pr-28 border-b-2 border-white dark:border-[#00001a] hover:border-gray-50'>
            <LocalOfferIcon/>
            <p>Promotions</p>
        </div>
      </div>
